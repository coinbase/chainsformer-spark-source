...
public class TestConnector {
    ...
    public static void setUp() throws Exception {
        ...
        conf = new SparkConf()
                ...
                .set("spark.flight.endpoint.useTls", "false")
...
//              .set("spark.flight.endpoint.useTls", "true")
//              .set("spark.flight.endpoint.host", "data-chainsformer-ethereum-mainnet-dev.cbhq.net")
//              .set("spark.flignht.endpoint.useTls", "false")
//              .set("spark.flight.endpoint.host", "localhost")
//              .set("spark.flight.endpoint.port", "9090")
    ...
    public void testConnectDev() {
        ...
        df.printSchema();
//    df.select("gas").show();
//    df.write().mode("overwrite").saveAsTable("d");
//    SQLContext.getOrCreate(sc.sc()).sql("select trace from d").show();
//    df.write().saveAsTable("abc");
