...
object FlightArrowUtils {
  ...
  def fromArrowType(dt: ArrowType): DataType = dt match {
    ...
    case int: ArrowType.Int if int.getBitWidth == 8 => ByteType
    case int: ArrowType.Int if int.getBitWidth == 8 * 2 => ShortType
    case int: ArrowType.Int if int.getBitWidth == 8 * 4 => IntegerType
